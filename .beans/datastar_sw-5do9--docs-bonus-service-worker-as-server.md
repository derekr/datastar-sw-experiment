...
updated_at: 2026-03-05T23:39:36Z
...
## Summary of Changes\n\nAdded DocsServiceWorkerContent component (9 sections) covering: SW as experiment vs recommended pattern, fetch interception, base() for subpath, install/activate/idle kill lifecycle, ephemeral state table, SSE in SW, debugging in separate console context, dev friction with reg.update() fix, and pros/cons table.
